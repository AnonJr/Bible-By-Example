...
function currentSlide() {
	...
	cs.innerHTML = '<a id="plink" href="">' + 
		...
		if (incrementals[snum].length > 0) {
			sc.innerHTML = '[' + incpos + '/' + incrementals[snum].length + ']';
		} else {
			sc.innerHTML = '&nbsp;';
		}
	...
	if (s5mode) {
		switch (key.which) {
			...
			case 35: // end
				...
				break;
			case 66: //b
				//TODO: Insert a case for the "b" key, set so the remote's "Blank" will trigger the video play.
				break;
			case 67: // c
				showHide('k');
				break;
...
function createControls() {
	...
	'<div id="navLinks">' +
	'<a accesskey="n" id="show-notes" href="javascript:createNotesWindow();" title="Show Notes"><span class="fa fa-list-alt"></span><\/a>' +
	'<a accesskey="t" id="toggle" href="javascript:toggle();"><span class="fa fa-file-text-o"></span><\/a>' +
	'<a accesskey="z" id="prev" href="javascript:go(-1);"><span class="fa fa-step-backward"></span><\/a>' +
	'<a accesskey="x" id="next" href="javascript:go(1);"><span class="fa fa-step-forward"></span><\/a>' +
...
function startup() {
	...
	//document.onclick = clicker; //IE seems to want to advance the slide when clicking play...
}
